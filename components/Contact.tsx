    ...
    <section id="contact" className="w-full max-w-6xl mx-auto px-4 pt-2 pb-8">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 max-w-5xl mx-auto">
        ...
        <a 
          ...
          className="block"
        >
          <div className="bg-slate-800 rounded-xl shadow-lg p-8 text-center hover:bg-slate-700 transition-all duration-300 hover:scale-105 cursor-pointer h-48 flex flex-col justify-center border-l-4 border-cyan-400">
