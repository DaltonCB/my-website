  ...
  return (
    <section id="contact" className="w-full max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 max-w-5xl mx-auto">
        {/* Email Card */}
        <div className="bg-white/10 backdrop-blur-lg rounded-xl shadow-lg p-8 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105 h-48 flex flex-col justify-center">
        ...
        <a 
          ...
          className="block"
        >
          <div className="bg-white/10 backdrop-blur-lg rounded-xl shadow-lg p-8 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105 cursor-pointer h-48 flex flex-col justify-center">
            <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-gray-700 to-gray-900 rounded-full flex items-center justify-center">
            ...
            <h3 className="text-xl font-semibold text-indigo-300 mb-2">GitHub</h3>
